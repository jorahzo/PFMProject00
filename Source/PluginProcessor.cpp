...
//==============================================================================
const juce::String PFMProject00AudioProcessor::getName() const
{
...
const juce::String PFMProject00AudioProcessor::getProgramName (int index)
{
    return {};
}

void PFMProject00AudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void PFMProject00AudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
juce::AudioProcessorEditor* PFMProject00AudioProcessor::createEditor()
{
    return new PFMProject00AudioProcessorEditor (*this);
}

//==============================================================================
void PFMProject00AudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
